...
export default function Host() {
    ...
    const sideBar = [
        {title: "Trang chủ", icon: <PresentationChartBarIcon className="h-7 w-7 max-[1270px]:h-12 max-[1270px]:w-12" />, link: "/host/property/statistic"},
        {title: "Quản lý tài sản", icon: <ShoppingBagIcon className="h-7 w-7 max-[1270px]:h-12 max-[1270px]:w-12" />, link: "/host/property/list"},
