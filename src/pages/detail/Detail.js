        ...
        <div className="w-[55%] pl-6 box-border">
          ...
          <div className="pt-6 pb-6 border-b-2">
            ...
            <div className="rating text-lg font-semibold flex pt-4">
              <p>{detail.rating}</p>
              <FontAwesomeIcon className="pt-[2px] text-yellow-300 stroke-black ml-[2px]" size="lg" icon={icon({name: 'star', family: 'classic', style: 'solid'})} />
            </div>
          </div>
            ...
            <div className="w-full pt-6 pb-6 flex justify-items-center border-b-2">
              ...
              <div className="ml-3">
                <div className="text-base font-semibold">
                  <p>Hosted by {detail.owner?.firstName} {detail.owner?.lastName}</p>
                </div>
          ...
          {/* info-service */}
            <div className="w-full h-64 pt-6 pb-6 flex flex-col border-b-2 justify-between">
                <div className="flex justify-items-center">
                    <FontAwesomeIcon className="stroke-slate-950 p-2" color="white" size="2x" icon={icon({name: 'puzzle-piece', family: 'classic', style: 'solid'})} />
                    <div className="ml-3">
          ...
          <div className="w-[350px] h-[450px] rounded-2xl shadow-checkout-shadow border-[#e9eaee] border-[1px]">
              <div className="p-5">
                  ...
                  <div className="pt-6 pb-6 flex flex-col justify-between">
                    ...
                    <input type="text" className="border-black border-[1px] mt-3"/>
                  </div>
                  <div className="flex flex-col justify-between">
                    <button className="h-12 bg-red-600 rounded-xl" type="submit"><p className="text-white font-medium">Đặt phòng</p></button>
                  </div>
