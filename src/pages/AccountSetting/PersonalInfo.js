      ...
      <div className='lg:flex justify-between'>
        ...
        <div className='lg:w-[35%] mt-14 p-5 border border-gray-700 rounded-2xl'>
          ...
          <div className='flex flex-col gap-4'>
            ...
            <p className='text-gray-500'>Thông tin liên lạc và chi tiết cá nhân có thể được chỉnh sửa. Nếu thông tin này được sử dụng để xác minh danh tính của bạn, bạn sẽ cần được xác minh lại vào lần đặt chỗ tiếp theo—hoặc để tiếp tục đón tiếp khách.</p>
          </div>
          <hr/>
          <div className='flex flex-col gap-4'>
