      ...
      <div className="flex flex-col xl:px-[24rem] py-[4rem] lg:px-[7rem] md:px-[5rem] sm:px-[2rem] ssm:px-[2rem] mt-32">
        ...
        <div className="mt-16 lg:w-[55%]">
          <div className="flex gap-5 font-medium">
            ...
            >
              <p className={currentActive == 0 ? "text-[#008489]" : ""}>
                ĐĂNG NHẬP
              </p>
            </NavLink>
            <NavLink
              to="/account-settings/login-and-security/login-requests"
              onClick={() => setCurrentActive(1)}
            >
              <p className={currentActive == 1 ? "text-[#008489]" : ""}>
                YÊU CẦU ĐĂNG NHẬP
              </p>
            </NavLink>
            <NavLink
              to="/account-settings/login-and-security/shared-access"
              onClick={() => setCurrentActive(2)}
            >
              <p className={currentActive == 2 ? "text-[#008489]" : ""}>
                TRUY CẬP CHIA SẺ
              </p>
            </NavLink>
          </div>
      ...
      <div className="lg:flex lg:justify-between">
        ...
        <div className="flex flex-col gap-3 lg:w-[35%] h-fit p-5 border border-gray-700 rounded-lg">
          <svg
            ...
            focusable="false"
            fill="currentColor"
            className="h-[40px] w-[40px] block text-[#Ffb400]"
          >
