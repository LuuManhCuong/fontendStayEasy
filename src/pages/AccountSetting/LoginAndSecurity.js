  ...
  return (
    ...
    <div className='flex flex-col py-[4rem] mt-32 max-[768px]:mt-9 min-[1286px]:px-[24rem] min-[640px]:px-[7rem] max-[640px]:px-[2rem]'>
      ...
      <div className='mt-16 lg:w-[55%]'>
        ...
        {currentActive==0?<Login/>:currentActive==1?<LoginRequests/>:<SharedAccess/>}
    </div>
    <Footer/>
    </>
  )
    ...
    <>
      <div className='lg:flex lg:justify-between'>
        <div className='lg:w-[55%]'>
          ...
          {/* password */}
          <Infor title="Mật khẩu" value="Cập nhật lần cuối 7 ngày trước" button="Thay đổi"/>
          <hr/>

          <h1 className='font-bold text-gray-600 mt-12 mb-12'>Social accounts</h1>
          {/* Facebook */}
          ...
          <h1 className='font-bold text-gray-600 mt-12 mb-12'>Device history</h1>
          {/* Name */}
          <Infor title="Thiết bị" value="Last updated 7 days ago" button="Đăng xuất thiết bị"/>
          <hr/>
        </div>
        <div className='flex flex-col gap-3 lg:w-[35%] h-fit p-5 border border-gray-700 rounded-lg'>
          ...
          <h3 className='text-3xl'>Hãy làm cho tài khoản của bạn an toàn hơn</h3>
          <h4 className='text-[1.7rem]'>Bảo mật tài khoản của bạn: <span className='font-normal text-gray-500 text-[1.7rem]'>Thấp</span></h4>
          <p>Chúng tôi luôn nỗ lực tìm cách tăng cường sự an toàn trong cộng đồng của mình. Đó là lý do tại sao chúng tôi xem xét mọi tài khoản để đảm bảo tài khoản đó an toàn nhất có thể.</p>
          <div className='w-[20%]'><hr/></div>
          <button className='bg-[#008489] w-[13rem] px-5 py-3 rounded-lg text-white font-bold'>cải thiện</button>
        </div>
      </div>
      <div>
        ...
        <div className='flex justify-between'>
          ...
          <button className='text-red-600 hover:underline hover:text-[#008489]'>Vô hiệu hóa</button>
        </div>
        <hr/>
      </div>
    </>
...
const LoginRequests = ()=>{
  return(
    <>
      <div className='lg:flex lg:justify-between'>
        <div className='lg:w-[55%]'>
          <h1 className='font-bold text-gray-600 mt-16 mb-16'>Yêu cầu đăng nhập</h1>
          <p>Các thành viên trong nhóm có thể phải nhập mã xác minh khi đăng nhập vào tài khoản này lần đầu tiên. Phê duyệt hoặc từ chối yêu cầu đăng nhập của họ trên trang này.</p>
          {/* Pending requests */}
          <h2 className='font-medium text-gray-600 mt-12 mb-12'>Yêu Cầu Đang Đợi Giải Quyết</h2>
          <hr/>
          {/* Approved requests */}
          <h2 className='font-medium text-gray-600 mt-12 mb-12'>Yêu cầu được phê duyệt</h2>
          <hr/>
          {/* Satisfied requests */}
          <h2 className='font-medium text-gray-600 mt-12 mb-12'>Yêu cầu được đáp ứng</h2>
          <hr/>
          {/* Declined requests */}
          <h2 className='font-medium text-gray-600 mt-12 mb-12'>Yêu cầu bị từ chối</h2>
          <hr/>
        </div>
        <div className='flex flex-col gap-3 lg:w-[35%] h-fit p-5 border border-gray-700 rounded-lg'>
          <svg viewBox="0 0 24 24" role="presentation" aria-hidden="true" focusable="false" fill='currentColor' className='h-[40px] w-[40px] block text-[#Ffb400]'><path d="m5 20.5a.5.5 0 0 1 -.5.5h-.5v.5a.5.5 0 0 1 -1 0v-.5h-.5a.5.5 0 0 1 0-1h .5v-.5a.5.5 0 0 1 1 0v .5h.5a.5.5 0 0 1 .5.5zm1.5 1.5a.5.5 0 1 0 .5.5.5.5 0 0 0 -.5-.5zm16-20h-.5v-.5a.5.5 0 0 0 -1 0v .5h-.5a.5.5 0 0 0 0 1h .5v.5a.5.5 0 0 0 1 0v-.5h.5a.5.5 0 0 0 0-1zm-2.58 4.87a13.41 13.41 0 0 1 -6.76-3.2.37.37 0 0 0 -.63.26l.08 16.22a.38.38 0 0 0 .55.32 11.98 11.98 0 0 0 7.07-13.31.37.37 0 0 0 -.31-.3z"></path><path d="m14.39 8.32a1.93 1.93 0 0 0 -3.66 0l-2.42 4.85a3.09 3.09 0 0 0 -.4 1.61 2.36 2.36 0 0 0 2.23 2.23 3.95 3.95 0 0 0 2.42-1.06 3.95 3.95 0 0 0 2.42 1.06 2.36 2.36 0 0 0 2.23-2.23 3.09 3.09 0 0 0 -.4-1.61zm-2.72 4.38c0-.05.01-1.23.89-1.23s.88 1.18.88 1.23a3.25 3.25 0 0 1 -.88 1.83 3.25 3.25 0 0 1 -.89-1.83zm3.31 3.31a2.92 2.92 0 0 1 -1.71-.77 4.3 4.3 0 0 0 1.17-2.54 2.02 2.02 0 0 0 -1.8-2.22l-.08-.01a2.02 2.02 0 0 0 -1.89 2.15l.01.08a4.29 4.29 0 0 0 1.17 2.54 2.92 2.92 0 0 1 -1.71.77 1.36 1.36 0 0 1 -1.23-1.23 2.13 2.13 0 0 1 .29-1.16l2.42-4.85c.33-.65.55-.76.94-.76s.61.11.94.76l2.42 4.85a2.13 2.13 0 0 1 .29 1.16 1.36 1.36 0 0 1 -1.23 1.23zm7.01-10.35a.5.5 0 0 0 -.43-.4 13.03 13.03 0 0 1 -8.68-4.57.52.52 0 0 0 -.77 0 13.03 13.03 0 0 1 -8.68 4.57.5.5 0 0 0 -.43.4c-1.58 8.19 1.55 14.02 9.3 17.31a.5.5 0 0 0 .39 0c7.75-3.29 10.87-9.11 9.3-17.31zm-9.49 16.3c-7.1-3.09-9.91-8.25-8.57-15.76a13.98 13.98 0 0 0 8.57-4.43 13.98 13.98 0 0 0 8.57 4.43c1.33 7.51-1.48 12.67-8.57 15.76z" fill="#484848"></path></svg>
          <h3 className='text-3xl'>Giữ tài khoản của bạn an toàn</h3>
          <p>Chỉ trả lời các yêu cầu từ những người bạn biết. Tin tặc có thể muốn truy cập vào tài khoản của bạn bằng cách bắt chước email của thành viên trong nhóm.</p>
        </div>
      </div>
      <div>
  ...
  return(
    <div className='lg:flex lg:justify-between'>
      <div className='lg:w-[55%] mt-10'>
        ...
        <p>Xem xét cẩn thận từng yêu cầu trước khi phê duyệt quyền truy cập. Chúng tôi sẽ gửi email cho nhân viên hoặc đồng nghiệp của bạn mã gồm 4 chữ số cho phép họ đăng nhập vào tài khoản của bạn bằng thiết bị đáng tin cậy của họ.</p>
      </div>
      <div className='flex flex-col gap-3 lg:w-[35%] p-5 border border-gray-700 rounded-2xl'>
        ...
        <p>Khi bạn phê duyệt một yêu cầu, bạn cấp cho ai đó quyền truy cập đầy đủ vào tài khoản của bạn. Họ sẽ có thể thay đổi việc đặt chỗ và gửi tin nhắn thay mặt bạn.</p>
      </div>
    </div>
  );
};
...
const Infor = ({title, value, button})=>{
  return(
    <div className='flex justify-between my-8'>
        ...
        <button className='font-medium text-[1.7rem] ml-3 text-[#008489]'>{button}</button>
      </div>
  );
}
