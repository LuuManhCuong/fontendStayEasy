        ...
        <div className='lg:flex justify-between'>
            <div className='lg:w-[55%] my-14'>
                <div className=''>
                    ...
                    <p >Theo dõi tất cả các khoản thanh toán và hoàn lại tiền của bạn.</p>
                    <button className='px-[2rem] py-[1.2rem] my-8 bg-black rounded-xl text-white font-bold'>Quản lý thanh toán</button>
                </div>
                <div className='my-10'>
                    <h1>Phương thức thanh toán</h1>
                    <p className='text-gray-600'>Thêm phương thức thanh toán bằng hệ thống thanh toán an toàn của chúng tôi, sau đó bắt đầu lên kế hoạch cho chuyến đi tiếp theo của bạn.</p>
                </div>
                <hr/>
                <button className='px-[2rem] py-[1.2rem] my-8 bg-black rounded-xl text-white font-bold'>Thêm phương thức thanh toán</button>
                <div className='my-20'>
                    <h1>Tín dụng quà tặng Stayeasy</h1>
                    <button className='px-[2rem] py-[1.2rem] my-8 bg-black rounded-xl text-white font-bold'>Thêm thẻ quà tặng</button>
                </div>
                <div>
        ...
        <div className='lg:flex lg:justify-between lg:mb-24'>
            <div className='lg:w-[55%] my-14'>
                <div className=''>
                    ...
                    <p >Thêm ít nhất một phương thức thanh toán để chúng tôi biết nơi gửi tiền của bạn.</p>
                    <button className='px-[2rem] py-[1.2rem] my-8 bg-black rounded-xl text-white font-bold'>Thiết lập các khoản thanh toán</button>
                </div>
            </div>
            <div className='flex flex-col gap-3 lg:w-[35%] h-fit p-5 border border-gray-700 rounded-lg'>
                ...
                <button>
                    <div className='flex justify-between items-center text-start gap-5'>
                        <p className='underline font-medium'>Khi nào bạn sẽ nhận được khoản thanh toán của mình</p>
                        <svg xmlns="http://www.w3.org/2000/svg" height="20" width="14" viewBox="0 0 320 512"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>
                    </div>
                </button>
                <button>
                    <div className='flex justify-between items-center text-start gap-5'>
                        <p className='underline font-medium'>Cách thức thanh toán hoạt động</p>
                        <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 320 512"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>
                    </div>
                </button>
                <button>
                    <div className='flex justify-between items-center text-start gap-5'>
                        <p className='underline font-medium'>Đi tới lịch sử giao dịch của bạn</p>
                        <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 320 512"><path d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z"/></svg>
                    </div>
                </button>
            </div>
