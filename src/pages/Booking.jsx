                  ...
                  <div className="bg-white rounded-2xl shadow-lg z-50 max-w-[37%] w-full h-[65%]">
                    ...
                    <div className="px-10 py-4 overflow-auto max-h-[88%] z-50">
                      <p>
                        ...
                        invite, or a pet are responsible for damage during a
                        stay, your payment method may be charged.
                      </p>

                      <h3>What can I be charged for?</h3>
                      <p>
                        You could be charged for damage, any of your Host’s
                        stuff that goes missing, or unexpected cleaning costs
                        due to your stay.
                      </p>
