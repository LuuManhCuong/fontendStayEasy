...
const Feedback = ({ userId, propertyId, checkIsOwner }) => {
  ...
  const handleSendFeedback = () => {
    ...
    axios
      .post(
        `http://localhost:8080/api/v1/stayeasy/trip/feedback/add`,
        newFeedback
      )
  ...
  return (
    <div className="w-full">
          ...
          <div className="w-full rounded-2xl ml-10 p-4 bg-white mt-2 h-full shadow-checkout-shadow border-checkout-bg border-[1px] mb-4">
            <div className="flex relative">
              <h1 className="text-3xl">
                {feedbacks.user?.firstName || "Ẩn Danh"}
              </h1>
      ...
      <div
        className={` ${
          feedbacks ? "hidden" : ""
        } w-full mt-8 rounded-2xl shadow-checkout-shadow border-checkout-bg border-[1px] pl-8 pt-4 pb-4`}
      >
        <div className="flex flex-col justify-between">
          ...
          <div
            className={`${
              disable ? "hidden" : ""
            } w-full flex justify-end pr-12 pb-2 mt-3`}
          >
            <div
