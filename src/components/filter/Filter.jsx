...
function Filter() {
  ...
  const ItemCategories = [
    {
      icon: <CabinIcon style={{ fontSize: 30, color: "#717171" }} />,
      categoryName: "Cabin",
    },
    {
      icon: <SouthAmericaIcon style={{ fontSize: 30, color: "#717171" }} />,
      categoryName: "Đảo",
    },
    {
      icon: <BeachAccessIcon style={{ fontSize: 30, color: "#717171" }} />,
      categoryName: "Biển",
    },
    {
      icon: <AcUnitIcon style={{ fontSize: 30, color: "#717171" }} />,
      categoryName: "Tuyết",
    },
    {
      icon: <CastleIcon style={{ fontSize: 30, color: "#717171" }} />,
      categoryName: "Lâu đài",
    },
    {
      icon: <FestivalIcon style={{ fontSize: 30, color: "#717171" }} />,
      categoryName: "Cắm trại",
    },
    {
      icon: <PoolIcon style={{ fontSize: 30, color: "#717171" }} />,
      categoryName: "Hồ bơi",
    },
    {
      icon: <LandscapeIcon style={{ fontSize: 30, color: "#717171" }} />,
      categoryName: "Núi",
    },
    {
      icon: <BalconyIcon style={{ fontSize: 30, color: "#717171" }} />,
      categoryName: "Trang trọng",
    },
    {
      icon: <ForestIcon style={{ fontSize: 30, color: "#717171" }} />,
      categoryName: "Rừng",
    },
  ];
        ...
        <Slider {...settings} className="w-[75%] pl-16 pr-20">
          {dataCategory.map((item, index) => (
            <div
              ...
              className={active === item.categoryId ? "active-cate" : ""}
              onClick={() => {
                handleClick(item.categoryId);
                console.log("ac: ", item.categoryId);
            ...
            >
              <div className="flex flex-col items-center">
                ...
                <div>
                  <p className="text-xl text-[#717171] font-medium pb-1">
                    {item.categoryName}
                  </p>
                </div>
              </div>
