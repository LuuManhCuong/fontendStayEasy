  ...
  return (
    <header className="header">
      <Row className="heading">
        ...
        {/* NavBar */}
        <Col className="nav">
          <NavLink to="/" className={(navData) => navData.isActive ? "active nav-item" : "nav-item"}>
            Chỗ ở
          </NavLink>
          <NavLink to="/experience" className={(navData) => navData.isActive ? "active nav-item" : "nav-item"}>
            Trải nghiệm
          </NavLink>
          <NavLink to="/explore" className={(navData) => navData.isActive ? "active nav-item" : "nav-item"}>
            Khám phá
          </NavLink>
        </Col>

        <Col className="action">
          <NavLink to="/host/home" className={(navData) => (navData.isActive ? "active" : "")}>
      ...
      {page === "home" ? (
        <div className="search-wrap">
          <div className="search-address">
            ...
            <input type="text" className="search-text" value={keySearch}
              ...
              id="keySerch" name="keySearch" placeholder="Tìm kiếm địa điểm..."></input>
          </div>
          <div className="checkin">
            <label htmlFor="">Nhận phòng</label>
            <DatePicker className="search-text" selected={checkin} onChange={(date) => setCheckin(date)} minDate={today}/>
          </div>
          <div className="checkout">
            <label htmlFor="">Trả phòng</label>
            <DatePicker className="search-text" selected={checkout} onChange={(date) => setCheckout(date)} minDate={checkin.getTime() + 86400000}/>
          </div>
        ...
        <div className="search-wrap">
          <div className="search-address">
            ...
            {showHistory & (suggest?.length > 0) ? (
              <div tabindex="1" className="search-history" onBlur={() => { setShowHistory(false);}}>
                <h2>Gợi ý</h2>
                <ul className="suggest">
                  {suggest.map((e, i) => (
                    <Link className="suggest-item" key={i} to={`/explore/detail/${e.propertyId}`}
                      onClick={() => {
                        setShowHistory(false);
                      }}>
        ...
        <div className="search-wrap">
          ...
          <div className="clear" onClick={() => dispatch(keySearchSlice.actions.setKeySearch(""))}>
            <HighlightOffIcon className="clear-btn"></HighlightOffIcon>
          </div>
          <SearchIcon onClick={() => handleSearch()} className="search-btn"></SearchIcon>
        </div>
