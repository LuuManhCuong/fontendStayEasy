...
function Header({ page }) {
  ...
  const [isLogined, setIsLogined] = useState(localStorage.getItem('accesstoken')?true:false);
  ...
  return (
    <header className="header">
      <Row className="heading">
        ...
        <Col className="nav">
          <NavLink to="/" className={(navData) => navData.isActive ? "active nav-item" : "nav-item"}>Chỗ ở</NavLink>
          <NavLink to="/experience" className={(navData) => navData.isActive ? "active nav-item" : "nav-item"}>Trải nghiệm</NavLink>
          <NavLink to="/explore" className={(navData) => navData.isActive ? "active nav-item" : "nav-item"}>Khám phá</NavLink>
        </Col>

        <Col className="action">
          <NavLink to="/host/home" className={(navData) => (navData.isActive ? "active" : "")}>Cho thuê chỗ ở qua Airbnb</NavLink>

          {/* Menu */}
          <div className="account">
            <Dropdown>
              <Dropdown.Toggle className="account-btn" variant="dark" id="dropdown-basic">
              <svg className="ml-3" xmlns="http://www.w3.org/2000/svg" height="20" width="17.25" viewBox="0 0 448 512">
                ...
                <Avatar className="avatar ml-3" alt="avatar" src="https://mui.com/static/images/avatar/2.jpg"/>
              </Dropdown.Toggle>
                  ...
                  <Dropdown.Menu>
                    ...
                    <Dropdown.Item>
                      <div className="flex items-center">
                        ...
                        <button className="text-2xl py-2 px-4" onClick={logout}>Đăng xuất</button>
                      </div>
                    </Dropdown.Item>
                  </Dropdown.Menu>
                  :<Dropdown.Menu>
                    <Dropdown.Item>
                      <div className="flex items-center">
                        ...
                        <button className="text-2xl py-2 px-4" onClick={toggleLoginPopup}>Log in</button>
                      </div>
                    </Dropdown.Item>
                    <Dropdown.Item>
                      <div className="flex items-center">
                        ...
                        <button className="text-2xl py-2 px-4" onClick={toggleRegisterPopup}>Sign Up</button>
                      </div>
                    </Dropdown.Item>
                  </Dropdown.Menu>
                }
      ...
      {page === "home" ? (
        <div className="search-wrap">
          <div className="search-address">
            ...
            <input type="text" className="search-text" value={keySearch}
              onChange={(e) => setKeySearch(e.target.value)}
              id="keySerch" name="keySearch" placeholder="Tìm kiếm địa điểm..."/>
          </div>
          <div className="checkin">
            <label htmlFor="">Nhận phòng</label>
            <DatePicker className="search-text" selected={checkin}
              onChange={(date) => setCheckin(date)}
              minDate={today}/>
          </div>
          <div className="checkout">
            <label htmlFor="">Trả phòng</label>
            <DatePicker className="search-text" selected={checkout}
              onChange={(date) => setCheckout(date)}
              minDate={checkin.getTime() + 86400000}/>
          </div>
          <SearchIcon onClick={() => handleSearch()} className="search-btn"></SearchIcon>
        </div>
      ) : page === "explore" ? (
        <div className="search-wrap">
          <div className="search-address">
            ...
            {showHistory && (
              <div tabindex="1" className="search-history"
                onBlur={() => {
                  setShowHistory(false);
                }}>
                <h2>Gợi ý</h2>
      ...
      {isOpenLoginModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 overflow-auto">
          <div className="absolute inset-0 bg-gray-900 opacity-50" onClick={toggleLoginPopup}></div>
          {/* header area start */}
          <div className="bg-white rounded-2xl shadow-lg z-50 max-w-[37%] w-full h-[90%]">
            <div className="items-center font-bold rounded-t-lg w-full pb-2 pt-8 px-10">
              <button className="absolute z-100 -mr-2 text-gray-500 hover:text-gray-700" onClick={toggleLoginPopup}>
            ...
            <div className="px-10 py-4 overflow-auto max-h-[88%] z-50">
              ...
              <form>
                ...
                <div className="mb-4">
                  ...
                  <input type="email" id="email"
                    ...
                    value={username} onChange={(e) => setUsername(e.target.value)} aria-required/>
                </div>
                {/* Password */}  
                <div className="mb-6">
              ...
              {/* open signup modal */}
              <div className="justify-center text-center my-3">Bạn chưa có tài khoản? 
                <button onClick={toggleRegisterPopup} className="text-[#FF002C]"> Đăng ký</button>
              </div>
              {/* form login end  */}
      ...
      {isOpenRegisterModal && (
        <div className="fixed inset-0 flex items-center justify-center z-50 overflow-auto">
          <div className="absolute inset-0 bg-gray-900 opacity-50" onClick={toggleRegisterPopup}></div>

          {/* header area start */}
          <div className="bg-white rounded-2xl shadow-lg z-50 max-w-[37%] w-full h-[90%]">
            <div className="items-center font-bold rounded-t-lg w-full pb-2 pt-8 px-10">
              {/* close modal button */}
              <button className="absolute z-100 -mr-2 text-gray-500 hover:text-gray-700" onClick={toggleRegisterPopup}>
                <svg xmlns="http://www.w3.org/2000/svg" height="" width="15" viewBox="0 0 384 512">
                  <path d="M342.6 150.6c12.5-12.5 12.5-32.8 0-45.3s-32.8-12.5-45.3 0L192 210.7 86.6 105.4c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3L146.7 256 41.4 361.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L192 301.3 297.4 406.6c12.5 12.5 32.8 12.5 45.3 0s12.5-32.8 0-45.3L237.3 256 342.6 150.6z"/>
                </svg>
              </button>
            ...
            <div className="px-10 py-4 overflow-auto max-h-[88%] z-50">
              ...
              <form>
                ...
                <div className="mb-4">
                  <label htmlFor="email"
                    className="block text-gray-800 font-medium mb-2">Tên tài khoản<span className="text-red-500"> (*)</span>
                  </label>
                  <input type="email" id="email"
                    className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500"
                ...
                <div className="mb-6">
                  <label htmlFor="password"
                    className="block text-gray-800 font-medium mb-2">Mật khẩu<span className="text-red-500"> (*)</span>
                  </label>
                  <input type="password" id="password"
                    className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500"
                    value={password} onChange={(e) => setPassword(e.target.value)} required/>
                ...
                <div className="mb-6">
                  <label htmlFor="password" 
                    className="block text-gray-800 font-medium mb-2"> Nhập lại mật khẩu<span className="text-red-500"> (*)</span>
                  </label>
                  <input type="password" id="password"
                    className="w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:border-blue-500"
              ...
              {/* open login modal */}
              <div className="justify-center text-center my-3">Bạn chưa đã có tài khoản? 
                <button onClick={toggleLoginPopup} className="text-[#FF002C]"> Đăng nhập</button>
              </div>
              {/* form login end  */}
