...
function Header({ page }) {
  ...
  return (
    <header className="header">
      <div className="flex w-[100%] px-[6.2rem] top-0 items-center bg-white max-[320px]:px-10 justify-between">
          ...
          <div className="flex justify-center w-[33%] max-[1204px]:w-[55%] min-[768px]:flex max-[768px]:hidden gap-5 text-[1.8rem]">
              ...
              <NavLink to="/experience" className={(navData) =>
                  navData.isActive ? "font-medium nav-item" : "nav-item"
                }>
                Trải nghiệm
              </NavLink>
              <NavLink to="/explore" className={(navData) => {
                  return navData.isActive ? "font-medium nav-item" : "nav-item";
                }}>
                Khám phá
              </NavLink>
            </div>
          ...
          <div className="justify-end items-center w-[33%] max-[1204px]:w-[20%] gap-2 font-medium text-2xl flex">
            <NavLink to="/host/home" className={
                (navData) => navData.isActive ? "active hover:bg-gray-100 p-3 rounded-2xl max-[1204px]:hidden" : "hover:bg-gray-100 p-3 max-[1204px]:hidden rounded-full"
              }>
              ...
              <Dropdown>
                <DropdownToggle bsPrefix="false" className="bg-transparent border-white p-0"  id="dropdown-basic">
                  <div className="flex justify-center items-center gap-3 px-[0.6rem] py-2 bg-transparent border border-transparent rounded-full hover:shadow-md">
                    ...
                    <img className="w-14 h-14 rounded-full" alt="avatar" src="https://mui.com/static/images/avatar/2.jpg"/>
                    {/* <Avatar className="" alt="avatar" src="https://mui.com/static/images/avatar/2.jpg"/> */}
                  </div>
                </DropdownToggle>
                {isLogined ? (
        ...
        <div className="search-wrap">
          <div className="search-address">
            ...
            <input type="text" className="search-text" value={keySearch}
              ...
              id="keySerch" name="keySearch" placeholder={placeholder}/>
            {showHistory & (suggest?.length > 0) ? (
              ...
              >
                ...
                <ul className="suggest">
                  {suggest.map((e, i) => (
                    <Link className="suggest-item" key={i}
