...
function Card(props) {
    ...
    return (
      <div onClick={handleDetail} className="w-[23%] h-96 cursor-pointer" key={props.index}>
        <div className="w-full h-60 rounded-2xl relative overflow-hidden">
          ...
          <div className={`flex absolute top-3 right-3 text-fav-icon text-2xl ${active ? 'active' : ''}`} onClick={handleActive}>
