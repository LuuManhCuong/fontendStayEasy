...
export default function ButtonCustom() {
  return (
    <>
      {/* Facebook */}
      <button type="submit" className="relative flex items-center justify-center font-medium py-3 px-4 rounded-xl hover:bg-gray-200 w-full border border-black">
      ...
      {/* Google */}
      <button type="submit" className="relative flex items-center justify-center font-medium mt-4 py-3 px-4 rounded-xl hover:bg-gray-200 w-full border border-black">
        <div className="absolute left-0 top-0 bottom-0 flex items-center pl-8">
